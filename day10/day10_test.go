...
func TestDay10_PartOne(t *testing.T) {
	testCases := []struct {
		desc  string
		input string
		ans   int
		...
		{
			desc: "",
			input: `.7F77F-J-F.LF-|-LL.J-|-F.7-|77L-L.FLFFJ7-7777-|7-F7.LFF--7F.LJ7-J7F-7-FL-7J77|-L-7-F-F--.J7..7FFLJ7..|7.F|--7FL|-|7F--J---JF-LL-L7-|.|-LJ7.F
